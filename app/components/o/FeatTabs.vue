    ...
    <UContainer class="py-16 lg:py-24">
      <Motion :variants="childVariant">
        <div class="mx-auto max-w-[760px] text-center">
          ...
          <p class="text-lg text-muted lg:text-xl">
            Everything you need to build, deploy, and scale your applications with confidence.
          </p>
        </div>
      </Motion>
      <div class="mt-12 lg:mt-16">
        <UTabs v-model="tab" :items="feats" class="w-full">
              ...
              <div class="grid grid-cols-1 gap-10 lg:grid-cols-2 lg:gap-16">
                ...
                <div>
                  ...
                  <Motion
                    as="p"
                    :variants="childVariant"
                    class="mb-6 text-muted lg:text-lg"
                  >
                  ...
                  >
                    <Icon name="heroicons:check-circle" class="size-6 shrink-0 text-primary" />
                    <div>
