...
<template>
  <div class="relative w-full h-[500px] overflow-hidden">
    <div class="top-0 left-0 z-10 absolute bg-linear-to-l from-transparent to-bg w-12 h-full" />
    <div class="top-0 right-0 z-10 absolute bg-linear-to-r from-transparent to-bg w-12 h-full" />
      ...
      >
        ...
        >
          <NuxtImg
            ...
            width="300"
            height="120"
            class="border-[3px] border-default rounded-xl object-cover hover:scale-105 transition-transform duration-300 ease-in-out pointer-events-auto will-change-transform"
          />
        </div>
      </Motion>
    </div>
