  ...
  <Teleport :to="props.teleportTo">
    <AnimatePresence>
      ...
      >
        <Motion
          as="div"
          class="fixed inset-0 size-full bg-default/50"
        ...
        <Motion
          ...
          aria-modal="true"
          tabindex="-1"
          class="relative z-50 flex max-h-[85vh] w-[min(720px,calc(100vw-32px))] flex-col overflow-hidden rounded-2xl border border-transparent bg-default"
          :class="[props.class]"
          :initial="{
            opacity: 0,
            scale: 0.5,
        ...
        >
          ...
          >
            <svg
              ...
              class="size-4 text-default transition duration-200 group-hover:scale-125 group-hover:rotate-3"
            >
              <path
                stroke="none"
                d="M0 0h24v24H0z"
