...
description: Learn how to customize Muokkaus components with the Tailwind Variants API for advanced, flexible, and maintainable styling.
...
Muokkaus components are styled using the [Tailwind Variants](https://www.tailwind-variants.org/) API, which provides a powerful way to create variants and manage component styles.
...
::tip{to="/docs/getting-started/installation/#themedefaultvariants"}
...
You have multiple ways to customize the appearance of Muokkaus components, you can do it for all components at once or on a per-component basis.
